...
import re, unicodedata, yaml, functools

from ..config import settings

# One source of truth for what an abbreviation means: the same dictionary the
# benchmark generator corrupts descriptions with, read in the other direction.
D = settings.DATA_DIR / "dictionaries"
