...
Ported unchanged from the prototype's `engine/codegen.py`. It was already pure
and already correct; moving it is the whole migration for this file, and the
Damm table below is re-derived by the tests rather than trusted.
